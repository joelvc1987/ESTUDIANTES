...
namespace ESTUDIANTES
{
    public partial class Form2 : Form
    {
        ...
        {
            Conexion.Conectar();
            string insertar = "insert into profesor (codigo, nombres, apellidos, direccion) values(@codigo, @nombres, @apellidos, @direccion)";
        ...
        {
            Conexion.Conectar();
            string actualizar = "update profesor set codigo=@codigo, nombres=@nombres, apellidos=@apellidos, direccion=@direccion where codigo=@codigo";
        ...
        {
            Conexion.Conectar();
            string eliminar = "delete from profesor where codigo = @codigo";
